...
public class LineSegment implements Serializable, Cloneable {
    private static final int DEFAULT_COLOR = Color.rgb(100, 200, 200);
    ...
    protected int customizedColor;//Color if custom made
    ...
    public LineSegment(
            ...
            int selected,
            int customized, int customizedColor){
        a = p1;
        b = p2;
        this.active = active;
        this.color = color;
    ...
    public void setCustomizedColor(int c0) {
        customizedColor = c0;
    }
