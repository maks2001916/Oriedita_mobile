...
import com.example.oriedita_core.origami.crease_pattern.worker.FoldedFigure_Configurator;
...
public class FoldedFigure {
    ...
    public int folding_estimated_03() throws InterruptedException {
        ...
        Log.i("TAG","＜＜＜＜＜folding_estimated_03()_____基本枝職人bb_workerはcp_worker2 Receives a set of line segments (made from wire diagrams) from and organizes them.");
        bb_worker.set(wireFrame_worker2.getLineStore());
        Log.i("TAG","＜＜＜＜＜folding_estimated_03()_____基本枝職人bb_workerがbb_worker.bunkatu_seiri_for_Smen_hassei;実施。");
        ...
        Log.i("TAG","＜＜＜＜＜folding_estimated_03()_____展開図職人cp_worker3はbb_worker Takes a streamlined set of line segments from and splits them into subfaces.");
        Log.i("TAG","　　　folding_estimated_03()のcp_worker3.Senbunsyuugou2Tensyuugou(bb_worker.get());実施");
        wireFrame_worker3.setLineSegmentSet(bb_worker.get());

        Log.i("TAG","＜＜＜＜＜folding_estimated_03()_____上下表職人ct_workerは、展開図職人cp_worker3Receive a set of points from and set subface.");
    ...
    public int folding_estimated_04() throws InterruptedException {
        Log.i("TAG","＜＜＜＜＜folding_estimated_04;開始");
        ...
        Log.i("TAG","＜＜＜＜＜folding_estimated_04()_____上下表職人ct_workerMake a top-bottom table of the surface (the surface of the developed view before folding).");
        ...
        Log.i("TAG","＜＜＜＜＜oritatami_suitei_04()____終了");
    ...
    public int folding_estimated_05() throws InterruptedException {
        Log.i("TAG","＜＜＜＜＜folding_estimated_05()_____上下表職人ct_workerがct_worker.possible_overlapping_search()実施。");
