...
/**
 * Обработчик копирования 4 точек
 * Адаптированная версия MouseHandlerCreaseCopy4p для Android
 */
class MouseHandlerCreaseCopy4p : BaseMouseHandler() {
    ...
    private fun performCopy() {
        ...
        println("Выполнено копирование 4 точек: $oldTotal -> $newTotal линий")
    }
    ...
    override fun getName(): String = "Копирование 4 точек"
    
    override fun getDescription(): String = "Скопируйте линии по 4 точкам"
} 