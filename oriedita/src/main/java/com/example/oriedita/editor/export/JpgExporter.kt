...
/**
 * Экспортер JPG файлов
 * Адаптированная версия JpgExporter для Android
 */
class JpgExporter : FileExporter {
    
    override fun supports(filename: File): Boolean {
        return filename.name.lowercase().endsWith(".jpg") || filename.name.lowercase().endsWith(".jpeg")
    }
    ...
    override fun getExtension(): String = "jpg"
} 